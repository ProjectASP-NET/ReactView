...
<<<<<<<< Updated upstream:src/app/[locale]/(publicpages)/(home)/page.tsx
...
========
              <span className="relative z-10">{t('hero.ctaCatalog')}</span>
>>>>>>>> Stashed changes:src/app/[locale]/page.tsx
...
========
        ...
        <div className="grid max-w-6xl grid-cols-1 gap-8 md:grid-cols-3">
          {[
            { key: "original", title: t('whyUs.original.title'), desc: t('whyUs.original.description') },
            { key: "taste", title: t('whyUs.taste.title'), desc: t('whyUs.taste.description') },
            { key: "quality", title: t('whyUs.quality.title'), desc: t('whyUs.quality.description') },
          ].map((item) => (
            <div key={item.key} className="flex flex-col gap-4 rounded-3xl border border-(--card-border) bg-(--card-bg) p-8 transition-colors hover:bg-(--card-hover)">
>>>>>>>> Stashed changes:src/app/[locale]/page.tsx
