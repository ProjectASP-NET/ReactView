...
export function CartIcon() {
  ...
  return (
    <Link
      href = {PAGES.CART}
      className="relative flex h-10 w-10 items-center justify-center rounded-xl bg-[var(--card-bg)] border border-[var(--border)] transition-colors hover:border-[var(--text-secondary)]"
    >
