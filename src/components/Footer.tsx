  ...
  return (
    <footer className="w-full border-t border-white/10 bg-[#0a0a0a] pt-16 pb-8 mt-auto">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="flex flex-col items-center justify-between gap-8 border-b border-white/10 pb-12 sm:flex-row">
          <div className="flex items-center gap-4">
            <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-white/5 p-2 ring-1 ring-white/10">
              <Image
                src="/logo1.png"
                alt="D&D Liquid"
                width={40}
